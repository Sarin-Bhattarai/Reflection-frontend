...
import "../../utils/css/privacy.css";

const Privacy = () => {
  return (
    <>
      <section className="privacy topMargin">
        <div className="container">
          ...
          <div className="left-privacy">
            ...
            <p>
              ...
              completing applications, or requesting additional services, we
              will collect certain Personal Information about you so that we may
              adequately respond to your inquiry or offer services to you such
              as your first and last name, postal address, email address, and
              phone number.
            </p>
            ...
            <p>
              ...
              address; browser type and language; Internet Service Provider
              (ISP), referring and exit websites and applications; operating
              system; date/time stamp of activity; clickstream data; whether you
              are a first-time or a returning user; links you clicked on while
              in the Site; and your flow and navigation path through the Site.
              We use this information in a deidentified and aggregated fashion
              to help us administer the Site, analyze its usage, protect the
              Site and its content from inappropriate use, and improve your Site
              experience.
            </p>
          </div>
